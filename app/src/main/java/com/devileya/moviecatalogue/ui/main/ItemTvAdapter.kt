...
//        notifyDataSetChanged()
    ...
    inner class MovieViewHolder(override val containerView: View) :
        ...
        fun bindItem(
            ...
            itemView.tv_popularity.text = String.format(itemView.context.resources.getString(R.string.popularity), tvShow.popularity)
            itemView.tv_rate.text = String.format(itemView.context.resources.getString(R.string.rating), tvShow.vote_average)
            itemView.tv_date.text = String.format(itemView.context.resources.getString(R.string.date), tvShow.first_air_date)
