...
class ItemMovieAdapter(val movies: List<MovieModel>, val listener: (MovieModel) -> Unit)
    ...
    inner class MovieViewHolder(override val containerView: View) :
        ...
        fun bindItem(
            ...
            itemView.tv_popularity.text = String.format(itemView.context.resources.getString(R.string.popularity), movie.popularity)
            itemView.tv_rate.text = String.format(itemView.context.resources.getString(R.string.rating), movie.vote_average)
            itemView.tv_date.text = String.format(itemView.context.resources.getString(R.string.date), movie.release_date)
